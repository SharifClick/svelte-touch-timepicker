...
var app = (function () {
    ...
    function create_if_block(ctx) {
    	...
    	switcher0.$on("timeChange", /*timeChanged*/ ctx[10]);
    	...
    	switcher1.$on("timeChange", /*timeChanged*/ ctx[10]);
    	...
    	switcher2.$on("timeChange", /*timeChanged*/ ctx[10]);
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "touch-time svelte-169r17a");
    			add_location(div0, file$1, 112, 10, 2805);
    			attr_dev(div1, "class", "touch-time-picker svelte-169r17a");
    			add_location(div1, file$1, 113, 10, 2854);
    			attr_dev(button0, "class", "svelte-169r17a");
    			add_location(button0, file$1, 119, 10, 3286);
    			attr_dev(button1, "class", "svelte-169r17a");
    			add_location(button1, file$1, 120, 10, 3341);
    			attr_dev(div2, "class", "touch-time-reset svelte-169r17a");
    			add_location(div2, file$1, 118, 8, 3244);
    			attr_dev(div3, "class", "touch-time-wrapper svelte-169r17a");
    			add_location(div3, file$1, 111, 6, 2761);
    			attr_dev(div4, "class", "svelte-169r17a");
    			add_location(div4, file$1, 110, 4, 2748);
    			attr_dev(div5, "class", "touch-time-popup svelte-169r17a");
    			add_location(div5, file$1, 109, 2, 2711);

    			dispose = [
    				listen_dev(button0, "click", /*resetTime*/ ctx[9], false, false, false),
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input, "class", input_class_value = "" + (null_to_empty(/*classes*/ ctx[5]) + " svelte-169r17a"));
    			input.readOnly = true;
    			input.value = /*_time*/ ctx[1];
    			add_location(input, file$1, 107, 0, 2594);
    			dispose = listen_dev(input, "focus", /*focus_handler*/ ctx[11], false, false, false);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (!current || dirty & /*classes*/ 32 && input_class_value !== (input_class_value = "" + (null_to_empty(/*classes*/ ctx[5]) + " svelte-169r17a"))) {
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	const writable_props = ["time", "_time", "selectedHour", "selectedMeridiem", "visible", "classes"];
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("visible" in $$props) $$invalidate(4, visible = $$props.visible);
    		if ("classes" in $$props) $$invalidate(5, classes = $$props.classes);
    		if ("resetTime" in $$props) $$invalidate(9, resetTime = $$props.resetTime);
    		if ("timeChanged" in $$props) $$invalidate(10, timeChanged = $$props.timeChanged);
    	};
